...
syn region	bklBuildBlock	matchgroup=Normal start="\%\(\(program\|library\|shared-library\|loadable-module\|template\)\s\+\k\+\_s*\%(:[a-z,_\n ]\+\)\?\)\@<={" end="}" contains=@bklAnyBlock,bklBuildProp
